...
#define TARGET_BOARD_IDENTIFIER "FW45"
#define USBD_PRODUCT_STRING     "FLYWOOF41151"
...
#define USE_EXTI
#define GYRO_INT_EXTI           PB2
// DON'T ENABLE: will HALT MCU on init_fc()
//#define USE_MPU_DATA_READY_SIGNAL
//#define ENSURE_MPU_DATA_READY_IS_LOW  // just for testing
...
// #define SOFTSERIAL_1_TX_PIN     PB0     // Clash with TX2, possible to use as S.Port or VTX control
